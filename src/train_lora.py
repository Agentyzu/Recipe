...
def train_lora_model():
    ...
    raw_dataset_train = C2MRDataset("../data/input/C2MR_train.json", image_cache_dir="../image_cache")
    train_dataset = QwenVLRecipeDataset(raw_dataset_train, tokenizer, max_length=1024)
    
    raw_dataset_val = C2MRDataset("../data/input/C2MR_val.json", image_cache_dir="../image_cache")
